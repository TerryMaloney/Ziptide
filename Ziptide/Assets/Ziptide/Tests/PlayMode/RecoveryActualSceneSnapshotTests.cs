...
namespace Ziptide.Tests.PlayMode
{
    ...
    public sealed class RecoveryActualSceneSnapshotTests
    {
        ...
        public IEnumerator TearDown()
        {
            ...
            // Quiesce the canonical action assets and remove test-only XR devices before destroying
            // the runtime owners that hold them. RecoveryActualRigControllerSimulation restores each
            // action asset and touched rig state only after device removal has completed safely.
            _simulation?.Dispose();
            _simulation = null;
