...
namespace Ziptide.Tests.EditMode
{
    ...
    public class GardenTimingTests
    {
        ...
        public void Fresh_WithinWindow_PaysBonus()
        {
            ...
            {
                var plot = PlotAt(p);
                Assert.AreEqual(GardenService.HarvestTiming.Fresh, GardenService.TimingOf(plot, p, 1600 + 60));
        ...
        public void Prime_AfterFresh_BeforeOverripe_IsFlat()
        {
            ...
            try
            {
                ...
                Assert.AreEqual(GardenService.HarvestTiming.Prime, GardenService.TimingOf(plot, p, t));
        ...
        public void Overripe_StartsAtFull_ThenDecaysLinearly()
        {
            ...
            try
            {
                var plot = PlotAt(p);
                long onset = 1600 + 900;
                Assert.AreEqual(GardenService.HarvestTiming.Overripe, GardenService.TimingOf(plot, p, onset));
        ...
        public void BeforeReady_IsPrimeAndFlat()
        {
            ...
            {
                var plot = PlotAt(p);
                Assert.AreEqual(GardenService.HarvestTiming.Prime, GardenService.TimingOf(plot, p, 1500));
        ...
        public void PerPlantOverride_WidensTheFreshWindow()
        {
            ...
            try
            {
                ...
                Assert.AreEqual(GardenService.HarvestTiming.Fresh, GardenService.TimingOf(plot, p, 1600 + 250));
            }
            finally { Destroy(p); }
        }
        ...
        public void Harvest_FoldsTiming_IntoTheCreditedYield()
        {
            ...
            try
            {
                ...
                Assert.AreEqual(GardenService.HarvestTiming.Fresh, res.timing);
        ...
        public void Harvest_Overripe_PaysLessButNeverZero()
        {
            ...
            try
            {
                ...
                Assert.IsTrue(res.Success);
                Assert.AreEqual(GardenService.HarvestTiming.Overripe, res.timing);
