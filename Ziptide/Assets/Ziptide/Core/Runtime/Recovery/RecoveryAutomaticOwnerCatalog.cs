...
namespace Ziptide.Core
{
    ...
    public static class RecoveryAutomaticOwnerCatalog
    {
        private static readonly RecoveryAutomaticOwnerRegistration[] Registrations =
        {
            ...
            Gated("PLAYER_INPUT_SESSION_GUARD", "Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs", "Ziptide.Gameplay.PlayerInputSessionGuard", RecoveryFeatureId.PlayerRigPersistence),
