...
| P3 | ForgeCreatureBody + ForgeSkinnedBuilder + ⚠ coordination commit (forgeBodyId) + drone/swarmer bodies | 🟡 **CORE ✅ `0795527`** + genomes shipping: swarm_bug ✅ · light_grazer ✅ · **tendril ✅ (2026-07-10 — first P2-organic genome: noised OrganicBlob root-knot + 3-seg grasping tendrils, 11 bones)**. Remaining 4 organics (witness_mite/tether_swarm/husk_molter/warden) are TELL-RECOLORING behaviors — need the tell-preserving hook design first (eye-emissive as the tell carrier), do NOT naive-swap. Drones = DroneRuntime path, separate seam |
