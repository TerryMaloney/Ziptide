...
| P2 | New ops (Capsule/Frustum/Torus/SweepSpline/OrganicBlob) + modifiers + Quest-3 class budgets | 🟡 **commit 1 SHIPPED (2026-07-09)** — all 5 ops + taper/bend/noise modifiers (weld-safe fBm, pre-transform, fixed order taper→bend→noise) + validation contracts + old-asset hash stability + 13 P2 tests. Commit 2 = storyTag class budgets + a booth showcase recipe |
