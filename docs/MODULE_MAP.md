...
| **docs/project-brain/** | Shared project "mind" (maintained by the build Claudes): whole-project mental model, discrepancy ledger, and the cross-LLM coordination log. Start at `docs/project-brain/README.md`. |
