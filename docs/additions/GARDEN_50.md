...
| ~~4~~ | ✅ SHIPPED (`vvvv`): fresh-harvest bonus — `GardenService.TimingMultiplier` grants +25% within the fresh window; live on every harvest, per-plant overridable. | S | GardenService, PlantDefinition | |
