...
| 23 | Zipline traversal: WorldSpec declares POI-pair links; a builder strings a spline between anchor towers; ride uses fixed-seat comfort + vignette. | M | WorldSpec, POI network, zipline builder | |
