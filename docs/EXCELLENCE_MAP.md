...
| Automation/belts | 💎 (place/ride/persist/feed, gated) | Belts buildable in any world with a pad; item flow deterministic; conductor mode | `AutomationAuditRules` (area caps, save identity) + 31 tests |
