...
- [WARNING] TRAVEL_NO_COORDINATOR: No TravelCoordinator in scene. It may arrive as DontDestroyOnLoad from another scene, but verify patcher ran.
- [WARNING] PERF_MATERIALS_OVER_CAP: unique materials = 77 exceeds the HARD CAP 60 (QUEST_ART_AUDIO_PERFORMANCE_BUDGET) — promote this to a blocker after baselining.
...
- [WARNING] SKY_VISTA_UNWIRED: Scene has a canon vista in SkyVistaLibrary but no generated theme asset at Assets/Ziptide/Content/Worlds/Themes/ToxicCity_Theme.asset. The sky ships legacy until the scene's patcher authors a theme (ThemeAuthor).
...
- [WARNING] PERF_MATERIALS_OVER_TARGET: unique materials = 32 over the target 25 (cap 60) — budget attention needed.
...
- [WARNING] PERF_RENDERERS_OVER_TARGET: renderers = 990 over the target 900 (cap 2500) — budget attention needed.
...
- [WARNING] PERF_RENDERERS_OVER_TARGET: renderers = 958 over the target 900 (cap 2500) — budget attention needed.
