...
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:183` — `Cube(throwRoot, "MuzzleGantry", muzzle, new Vector3(26f, 20f, 8f), kit.palette.skyline, false);`
...
- **reference** · `Ziptide.Editor.Patching.ScenePatcherToxicCity` · `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherToxicCity.cs:416` — `/// no machines at all — JobDirector materialises repairables from the PACK, so there was`
- **reference** · `Ziptide.Editor.Patching.ScenePatcherToxicCity` · `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherToxicCity.cs:482` — `var jdGo = PatcherUtil.EnsureRootObject("JobDirector", Vector3.zero);`
- **reference** · `Ziptide.Editor.Patching.ScenePatcherToxicCity` · `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherToxicCity.cs:483` — `var director = PatcherUtil.EnsureComponent<JobDirector>(jdGo);`
...
- **reference** · `Ziptide.Gameplay.DispatchKiosk` · `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/DispatchKiosk.cs:20` — `private JobDirector _director;`
- **reference** · `Ziptide.Gameplay.DispatchKiosk` · `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/DispatchKiosk.cs:22` — `public void Bind(JobDirector director)`
- **reference** · `Ziptide.Gameplay.DispatchKiosk` · `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/DispatchKiosk.cs:30` — `_director = FindObjectOfType<JobDirector>();`
...
- **reference** · `Ziptide.Gameplay.ObjectiveBoard` · `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/ObjectiveBoard.cs:15` — `[SerializeField] private JobDirector jobDirector;`
- **reference** · `Ziptide.Gameplay.ObjectiveBoard` · `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/ObjectiveBoard.cs:30` — `public void Bind(JobDirector director)`
- **reference** · `Ziptide.Gameplay.ObjectiveBoard` · `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/ObjectiveBoard.cs:60` — `jobDirector = FindObjectOfType<JobDirector>();`
...
- **reference** · `Ziptide.Editor.Patching.ScenePatcherToxicCity` · `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherToxicCity.cs:494` — `var boardGo = PatcherUtil.EnsureRootObject("ObjectiveBoard", spawnPos + new Vector3(-1.5f, 1.6f, 1.5f));`
- **reference** · `Ziptide.Editor.Patching.ScenePatcherToxicCity` · `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherToxicCity.cs:495` — `PatcherUtil.EnsureComponent<ObjectiveBoard>(boardGo);`
...
- **reference** · `Ziptide.Tests.EditMode.FirstRouteFeelTests` · `Ziptide/Assets/Ziptide/Tests/EditMode/FirstRouteFeelTests.cs:80` — `public void ObjectiveBoard_SubscriptionAndCompletionPresentationAreOneShot()`
- **reference** · `Ziptide.Tests.EditMode.FirstRouteFeelTests` · `Ziptide/Assets/Ziptide/Tests/EditMode/FirstRouteFeelTests.cs:82` — `string source = ReadCode("Gameplay", "Runtime", "Jobs", "ObjectiveBoard.cs");`
...
- **reference** · `Ziptide.Editor.Patching.ToxicCityContractBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/ToxicCityContractBuilder.cs:134` — `private static RepairMachineCountStepDefinition RepairMachine(string assetName, string machineId, string label)`
- **reference** · `Ziptide.Editor.Patching.ToxicCityContractBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/ToxicCityContractBuilder.cs:137` — `var step = AssetDatabase.LoadAssetAtPath<RepairMachineCountStepDefinition>(path);`
- **reference** · `Ziptide.Editor.Patching.ToxicCityContractBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/ToxicCityContractBuilder.cs:139` — `if (created) step = ScriptableObject.CreateInstance<RepairMachineCountStepDefinition>();`
...
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:628` — `var castOff = ship.GetComponent<ShipCastOffRuntime>()`
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:629` — `?? ship.gameObject.AddComponent<ShipCastOffRuntime>();`
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:635` — `var castOff = ship.GetComponent<ShipCastOffRuntime>()`
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:636` — `?? ship.gameObject.AddComponent<ShipCastOffRuntime>();`
...
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:603` — `// real ~19-part silhouette now (ShipHullBuilder), same bounding box, so the boarding`
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:608` — `ShipHullBuilder.Build(ship, s.shipSize, kit.palette);`
