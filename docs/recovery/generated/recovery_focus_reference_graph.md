...
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:532` — `var castOff = ship.GetComponent<ShipCastOffRuntime>()`
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:533` — `?? ship.gameObject.AddComponent<ShipCastOffRuntime>();`
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:539` — `var castOff = ship.GetComponent<ShipCastOffRuntime>()`
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:540` — `?? ship.gameObject.AddComponent<ShipCastOffRuntime>();`
...
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:507` — `// real ~19-part silhouette now (ShipHullBuilder), same bounding box, so the boarding`
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:512` — `ShipHullBuilder.Build(ship, s.shipSize, kit.palette);`
