...
- **reference** · `Ziptide.Tests.EditMode.WeaponPerceptualAuditRulesTests` · `Ziptide/Assets/Ziptide/Tests/EditMode/WeaponPerceptualAuditRulesTests.cs:83` — `Transform muzzle = new GameObject("Muzzle").transform;`
