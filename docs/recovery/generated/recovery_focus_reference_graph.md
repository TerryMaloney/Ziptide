...
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:527` — `var castOff = ship.GetComponent<ShipCastOffRuntime>()`
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:528` — `?? ship.gameObject.AddComponent<ShipCastOffRuntime>();`
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:534` — `var castOff = ship.GetComponent<ShipCastOffRuntime>()`
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:535` — `?? ship.gameObject.AddComponent<ShipCastOffRuntime>();`
...
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:502` — `// real ~19-part silhouette now (ShipHullBuilder), same bounding box, so the boarding`
- **reference** · `Ziptide.Editor.Patching.CityBuilder` · `Ziptide/Assets/Ziptide/Editor/Patching/CityBuilder.cs:507` — `ShipHullBuilder.Build(ship, s.shipSize, kit.palette);`
