...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:406` **DONT_DESTROY_ON_LOAD** — `DontDestroyOnLoad(_xriManager.gameObject);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:416` **DONT_DESTROY_ON_LOAD** — `DontDestroyOnLoad(_xriManager.gameObject);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:424` **DONT_DESTROY_ON_LOAD** — `DontDestroyOnLoad(_xriManager.gameObject);`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs:25` **RUNTIME_BOOTSTRAP** — `[RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)]`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs:31` **RUNTIME_BOOTSTRAP** — `[RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.AfterSceneLoad)]`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:377` **INPUT_ACTION_REFERENCE** — `// The scene-local manager always has the correct InputActionManager+assets wired up.`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:393` **INPUT_ACTION_REFERENCE** — `// CRITICAL FIX: clear the OLD manager's InputActionManager asset list BEFORE`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:394` **INPUT_ACTION_REFERENCE** — `// destroying it. InputActionManager.OnDisable calls actionAsset.Disable() which`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:575` **INPUT_ACTION_REFERENCE** — `var primary = _xriManager != null ? _xriManager.GetComponent<InputActionManager>() : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:599` **INPUT_ACTION_REFERENCE** — `/// Guarantees the persistent rig owns its input. The scene's InputActionManager often`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:604` **INPUT_ACTION_REFERENCE** — `/// the rig references, (2) put them on an InputActionManager on the PERSISTENT manager`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:605` **INPUT_ACTION_REFERENCE** — `/// object, (3) clear the asset list on every other InputActionManager so their OnDisable`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:610` **INPUT_ACTION_REFERENCE** — `var assets = new System.Collections.Generic.List<InputActionAsset>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:611` **INPUT_ACTION_REFERENCE** — `void Add(InputActionAsset a) { if (a != null && !assets.Contains(a)) assets.Add(a); }`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:613` **INPUT_ACTION_REFERENCE** — `var allManagers = FindObjectsOfType<InputActionManager>(true);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:622` **INPUT_ACTION_REFERENCE** — `var primary = _xriManager.GetComponent<InputActionManager>()`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:623` **INPUT_ACTION_REFERENCE** — `?? _xriManager.gameObject.AddComponent<InputActionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:645` **INPUT_ACTION_REFERENCE** — `private static InputActionAsset GetActionAssetFromController(ActionBasedController c)`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:654` **INPUT_ACTION_REFERENCE** — `/// <summary>Clears m_ActionAssets on an InputActionManager so its OnDisable won't disable shared assets.</summary>`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:655` **INPUT_ACTION_REFERENCE** — `private static void ClearInputActionAssets(InputActionManager iam)`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:660` **INPUT_ACTION_REFERENCE** — `var field = typeof(InputActionManager).GetField(`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:663` **INPUT_ACTION_REFERENCE** — `field.SetValue(iam, new System.Collections.Generic.List<InputActionAsset>());`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:672` **INPUT_ACTION_REFERENCE** — `/// Clears the action asset list on an InputActionManager via reflection BEFORE`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:673` **INPUT_ACTION_REFERENCE** — `/// the manager is destroyed. This prevents InputActionManager.OnDisable from`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:679` **INPUT_ACTION_REFERENCE** — `var iam = mgr.GetComponent<InputActionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:683` **INPUT_ACTION_REFERENCE** — `var field = typeof(InputActionManager).GetField(`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:687` **INPUT_ACTION_REFERENCE** — `field.SetValue(iam, new System.Collections.Generic.List<InputActionAsset>());`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Locomotion/DashLocomotion.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Locomotion/DashLocomotion.cs:36` **INPUT_ACTION_REFERENCE** — `private InputAction _jumpAction;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Locomotion/DashLocomotion.cs:37` **INPUT_ACTION_REFERENCE** — `private InputAction _sprintAction;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Locomotion/DashLocomotion.cs:38` **INPUT_ACTION_REFERENCE** — `private InputAction _crouchAction;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Locomotion/DashLocomotion.cs:98` **INPUT_ACTION_REFERENCE** — `_jumpAction = new InputAction("ZiptideJump", InputActionType.Button);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Locomotion/DashLocomotion.cs:99` **INPUT_BUTTON_REFERENCE** — `_jumpAction.AddBinding("<XRController>{RightHand}/primaryButton"); // A`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Locomotion/DashLocomotion.cs:103` **INPUT_ACTION_REFERENCE** — `_sprintAction = new InputAction("ZiptideSprint", InputActionType.Button);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Locomotion/DashLocomotion.cs:108` **INPUT_ACTION_REFERENCE** — `_crouchAction = new InputAction("ZiptideCrouch", InputActionType.Button);`
...
### `Ziptide.Gameplay.PlayerInputSessionGuard` — 10 signal(s)
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs:21` **INPUT_ACTION_REFERENCE** — `/// InputActionManager the only enabled manager.`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs:47` **INPUT_ACTION_REFERENCE** — `/// Transfer the union of all action assets to the InputActionManager attached to the sole`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs:60` **INPUT_ACTION_REFERENCE** — `InputActionManager primary = canonicalXri.GetComponent<InputActionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs:68` **INPUT_ACTION_REFERENCE** — `InputActionManager[] managers = UnityEngine.Object.FindObjectsOfType<InputActionManager>(true);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs:69` **INPUT_ACTION_REFERENCE** — `var assets = new List<InputActionAsset>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs:82` **INPUT_ACTION_REFERENCE** — `InputActionManager manager = managers[i];`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs:86` **INPUT_ACTION_REFERENCE** — `manager.actionAssets = new List<InputActionAsset>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs:118` **INPUT_ACTION_REFERENCE** — `private static void AddAssets(InputActionManager manager, List<InputActionAsset> assets)`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs:121` **INPUT_ACTION_REFERENCE** — `foreach (InputActionAsset asset in manager.actionAssets)`
...
- Paths: `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:39` **INPUT_ACTION_REFERENCE** — `private InputAction _leftStick, _rightStick, _boostL3, _boostA;`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:68` **INPUT_ACTION_REFERENCE** — `_leftStick = new InputAction("ZiptideRideThrottle", InputActionType.Value);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:70` **INPUT_ACTION_REFERENCE** — `_rightStick = new InputAction("ZiptideRideSteer", InputActionType.Value);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:72` **INPUT_ACTION_REFERENCE** — `_boostL3 = new InputAction("ZiptideRideBoostL3", InputActionType.Button);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:74` **INPUT_ACTION_REFERENCE** — `_boostA = new InputAction("ZiptideRideBoostA", InputActionType.Button);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:75` **INPUT_BUTTON_REFERENCE** — `_boostA.AddBinding("<XRController>{RightHand}/primaryButton");`
...
- Paths: `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryInputSessionGuardTests.cs`
  ...
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryInputSessionGuardTests.cs:53` **INPUT_ACTION_REFERENCE** — `primary.actionAssets = new List<InputActionAsset> { primaryAsset };`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryInputSessionGuardTests.cs:57` **INPUT_ACTION_REFERENCE** — `InputActionManager duplicate = duplicateHost.AddComponent<InputActionManager>();`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryInputSessionGuardTests.cs:58` **INPUT_ACTION_REFERENCE** — `InputActionAsset duplicateAsset = CreateAsset("SceneAsset", "SceneAction");`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryInputSessionGuardTests.cs:59` **INPUT_ACTION_REFERENCE** — `duplicate.actionAssets = new List<InputActionAsset> { duplicateAsset };`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryInputSessionGuardTests.cs:67` **INPUT_ACTION_REFERENCE** — `Assert.IsTrue(primary.enabled, "The canonical InputActionManager was disabled.");`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryInputSessionGuardTests.cs:68` **INPUT_ACTION_REFERENCE** — `Assert.IsFalse(duplicate.enabled, "The scene duplicate InputActionManager stayed enabled.");`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryInputSessionGuardTests.cs:89` **INPUT_ACTION_REFERENCE** — `if (record.category == "InputActionManager" && record.active && record.enabled)`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryInputSessionGuardTests.cs:93` **INPUT_ACTION_REFERENCE** — `"The runtime census still sees more than one enabled InputActionManager.");`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryInputSessionGuardTests.cs:103` **INPUT_ACTION_REFERENCE** — `private InputActionAsset CreateAsset(string assetName, string actionName)`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryInputSessionGuardTests.cs:105` **INPUT_ACTION_REFERENCE** — `InputActionAsset asset = ScriptableObject.CreateInstance<InputActionAsset>();`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryInputSessionGuardTests.cs:119` **INPUT_ACTION_REFERENCE** — `InputActionManager[] input = Resources.FindObjectsOfTypeAll<InputActionManager>();`
...
- Paths: `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs`
  ...
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:274` **INPUT_ACTION_REFERENCE** — `InputActionManager input = CanonicalInputManager();`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:281` **INPUT_ACTION_REFERENCE** — `"The canonical InputActionManager owns no action assets at Home Hub settlement.");`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:306` **INPUT_ACTION_REFERENCE** — `InputActionManager input = CanonicalInputManager();`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:332` **INPUT_ACTION_REFERENCE** — `Assert.AreEqual(1, ActiveManagerCount(census, "InputActionManager"));`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:387` **INPUT_ACTION_REFERENCE** — `private static InputActionManager CanonicalInputManager()`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:390` **INPUT_ACTION_REFERENCE** — `InputActionManager input = manager.GetComponent<InputActionManager>();`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:392` **INPUT_ACTION_REFERENCE** — `"The canonical XRInteractionManager has no InputActionManager beside it.");`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:393` **INPUT_ACTION_REFERENCE** — `Assert.IsTrue(input.enabled, "The canonical InputActionManager is disabled.");`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:397` **INPUT_ACTION_REFERENCE** — `private static int[] InputAssetIds(InputActionManager manager, bool assertEnabled)`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:402` **INPUT_ACTION_REFERENCE** — `foreach (InputActionAsset asset in manager.actionAssets)`
...
- Paths: `Ziptide/Assets/Ziptide/Editor/Patching/ShipHullBuilder.cs`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ShipHullBuilder.cs:94` **CREATE_PRIMITIVE** — `var go = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ShipHullBuilder.cs:130` **SHADER_FIND** — `var shader = Shader.Find("Universal Render Pipeline/Lit");`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ShipHullBuilder.cs:131` **SHADER_FIND** — `if (shader == null) shader = Shader.Find("Standard");`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ShipHullBuilder.cs:132` **RUNTIME_MATERIAL_CREATE** — `var m = new Material(shader) { name = "ShipMat_" + ColorUtility.ToHtmlStringRGB(color) };`
...
- Codes: `NEW_GAME_OBJECT`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:306` **NEW_GAME_OBJECT** — `var go = new GameObject(Ziptide.Core.ZiptideConstants.GoBeltRig);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:421` **NEW_GAME_OBJECT** — `var go = new GameObject("__XRI");`
...
### `Ziptide.Gameplay.DroneCombatBehavior` — 5 signal(s)
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Enemies/DroneCombatBehavior.cs`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Enemies/DroneCombatBehavior.cs:215` **CREATE_PRIMITIVE** — `_telegraphFx = GameObject.CreatePrimitive(PrimitiveType.Sphere);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Enemies/DroneCombatBehavior.cs:224` **SHADER_FIND** — `var shader = Shader.Find("Universal Render Pipeline/Unlit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Enemies/DroneCombatBehavior.cs:225` **SHADER_FIND** — `if (shader == null) shader = Shader.Find("Universal Render Pipeline/Lit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Enemies/DroneCombatBehavior.cs:226` **RUNTIME_MATERIAL_CREATE** — `var mat = new Material(shader);`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:136` **NEW_GAME_OBJECT** — `var root = new GameObject("SpawnMarkers");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:140` **NEW_GAME_OBJECT** — `var go = new GameObject("Marker_" + m.markerId);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:152` **NEW_GAME_OBJECT** — `var root = new GameObject("BuildSockets");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:158` **NEW_GAME_OBJECT** — `var go = new GameObject("Socket_" + s.id);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:169` **NEW_GAME_OBJECT** — `var root = new GameObject("Gardens");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:176` **NEW_GAME_OBJECT** — `var go = new GameObject("Garden_" + g.id);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:192` **NEW_GAME_OBJECT** — `var root = new GameObject("Mines");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:198` **NEW_GAME_OBJECT** — `var go = new GameObject("Mine_" + m.id);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:209` **NEW_GAME_OBJECT** — `var root = new GameObject("Machines");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:214` **NEW_GAME_OBJECT** — `var go = new GameObject("Machine_" + m.machineId);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:225` **NEW_GAME_OBJECT** — `var root = new GameObject("Choices");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:230` **NEW_GAME_OBJECT** — `var go = new GameObject("Choice_" + c.choiceId);`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/MeleeWeaponRuntime.cs`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/MeleeWeaponRuntime.cs:137` **CREATE_PRIMITIVE** — `var s = GameObject.CreatePrimitive(PrimitiveType.Sphere);`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/PistolRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/PistolRuntime.cs:11` **XR_INTERACTABLE_COMPONENT** — `[RequireComponent(typeof(XRGrabInteractable))]`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/PistolRuntime.cs:34` **NEW_GAME_OBJECT** — `var m = new GameObject("Muzzle");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/PistolRuntime.cs:123` **CREATE_PRIMITIVE** — `var go = GameObject.CreatePrimitive(PrimitiveType.Sphere);`
...
### `Ziptide.Gameplay.RepairableMachine` — 18 signal(s)

- Codes: `CREATE_PRIMITIVE`, `NEW_GAME_OBJECT`, `RUNTIME_MATERIAL_CREATE`, `SHADER_FIND`, `TEXTMESH_COMPONENT`, `XR_INTERACTABLE_COMPONENT`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:66` **CREATE_PRIMITIVE** — `var body = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:74` **CREATE_PRIMITIVE** — `var lamp = GameObject.CreatePrimitive(PrimitiveType.Sphere);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:83` **NEW_GAME_OBJECT** — `var labelGo = new GameObject("Label");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:84` **TEXTMESH_COMPONENT** — `_label = labelGo.AddComponent<TextMesh>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:94` **CREATE_PRIMITIVE** — `var socket = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:105` **NEW_GAME_OBJECT** — `var panel = new GameObject("Panel");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:112` **XR_INTERACTABLE_COMPONENT** — `var panelGrab = panel.AddComponent<XRGrabInteractable>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:115` **CREATE_PRIMITIVE** — `var panelVisual = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:122` **CREATE_PRIMITIVE** — `var sw = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:129` **XR_INTERACTABLE_COMPONENT** — `var swInteractable = sw.AddComponent<XRSimpleInteractable>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:138` **NEW_GAME_OBJECT** — `var part = new GameObject("Part_" + _def.partItemId);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:144` **XR_INTERACTABLE_COMPONENT** — `var partGrab = part.AddComponent<XRGrabInteractable>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:146` **CREATE_PRIMITIVE** — `var partVisual = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:151` **NEW_GAME_OBJECT** — `var partLabel = new GameObject("PartLabel");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:152` **TEXTMESH_COMPONENT** — `var ptm = partLabel.AddComponent<TextMesh>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:263` **SHADER_FIND** — `var shader = Shader.Find("Universal Render Pipeline/Lit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:264` **SHADER_FIND** — `if (shader == null) shader = Shader.Find("Standard");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:266` **RUNTIME_MATERIAL_CREATE** — `var mat = new Material(shader);`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/TaserDartGunRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/TaserDartGunRuntime.cs:10` **XR_INTERACTABLE_COMPONENT** — `[RequireComponent(typeof(XRGrabInteractable))]`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/TaserDartGunRuntime.cs:33` **NEW_GAME_OBJECT** — `var m = new GameObject("Muzzle");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/TaserDartGunRuntime.cs:72` **CREATE_PRIMITIVE** — `var dart = GameObject.CreatePrimitive(PrimitiveType.Cylinder);`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/TaserDartProjectile.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/TaserDartProjectile.cs:91` **CREATE_PRIMITIVE** — `var spark = GameObject.CreatePrimitive(PrimitiveType.Sphere);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/TaserDartProjectile.cs:100` **SHADER_FIND** — `var shader = Shader.Find("Universal Render Pipeline/Unlit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/TaserDartProjectile.cs:101` **SHADER_FIND** — `if (shader == null) shader = Shader.Find("Universal Render Pipeline/Lit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/TaserDartProjectile.cs:104` **RUNTIME_MATERIAL_CREATE** — `var mat = new Material(shader);`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/WorldRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/WorldRuntime.cs:129` **NEW_GAME_OBJECT** — `GameObject go = new GameObject("WorldDirector");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/WorldRuntime.cs:167` **NEW_GAME_OBJECT** — `GameObject go = new GameObject("PlayAreaBounds");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/WorldRuntime.cs:183` **NEW_GAME_OBJECT** — `GameObject go = new GameObject("ThemeSwitchStation");`
...
### `Ziptide.Ship.VehicleRuntime` — 12 signal(s)

- Codes: `CREATE_PRIMITIVE`, `NEW_GAME_OBJECT`, `RUNTIME_MATERIAL_CREATE`, `SHADER_FIND`, `TEXTMESH_COMPONENT`, `XR_INTERACTABLE_COMPONENT`
- Paths: `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:90` **CREATE_PRIMITIVE** — `var hull = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:97` **CREATE_PRIMITIVE** — `var prow = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:105` **CREATE_PRIMITIVE** — `var seat = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:115` **NEW_GAME_OBJECT** — `var labelGo = new GameObject("RideLabel");`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:118` **TEXTMESH_COMPONENT** — `_label = labelGo.AddComponent<TextMesh>();`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:132` **CREATE_PRIMITIVE** — `var tile = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:138` **NEW_GAME_OBJECT** — `var label = new GameObject("Label");`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:142` **TEXTMESH_COMPONENT** — `var tm = label.AddComponent<TextMesh>();`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:149` **XR_INTERACTABLE_COMPONENT** — `var interactable = tile.AddComponent<XRSimpleInteractable>();`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:266` **SHADER_FIND** — `var shader = Shader.Find("Universal Render Pipeline/Lit");`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:267` **SHADER_FIND** — `if (shader == null) shader = Shader.Find("Standard");`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/VehicleRuntime.cs:269` **RUNTIME_MATERIAL_CREATE** — `var mat = new Material(shader);`
...
- Paths: `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs`
  - `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs:66` **NEW_GAME_OBJECT** — `StringAssert.Contains("new GameObject(\"__HOME_HUB_RUNTIME\").AddComponent<HomeHubRuntime>()", source);`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:374` **XRI_MANAGER_LOOKUP** — `var allManagers = FindObjectsOfType<XRInteractionManager>(true);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:423` **XRI_MANAGER_CREATE** — `_xriManager = go.AddComponent<XRInteractionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:450` **XRI_MANAGER_ASSIGN** — `i.interactionManager = _xriManager;`
...
- Codes: `XRI_MANAGER_LOOKUP`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerInputSessionGuard.cs:105` **XRI_MANAGER_LOOKUP** — `UnityEngine.Object.FindObjectsOfType<XRInteractionManager>(true);`
...
- Codes: `XRI_MANAGER_ASSIGN`, `XRI_MANAGER_LOOKUP`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:249` **XRI_MANAGER_LOOKUP** — `var mgr = Object.FindObjectOfType<XRInteractionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:250` **XRI_MANAGER_ASSIGN** — `if (mgr != null) interactable.interactionManager = mgr;`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:57` **EVENT_DECLARATION** — `public static event Action<bool> BootPresentationReady;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:57` **STATIC_EVENT_DECLARATION** — `public static event Action<bool> BootPresentationReady;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:58` **EVENT_DECLARATION** — `public static event Action<PlayerProfile> NewGameProfileCreated;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:58` **PLAYER_PROFILE_REFERENCE** — `public static event Action<PlayerProfile> NewGameProfileCreated;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:58` **STATIC_EVENT_DECLARATION** — `public static event Action<PlayerProfile> NewGameProfileCreated;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:59` **EVENT_DECLARATION** — `public static event Action<HomeHubChoice> ChoiceSelected;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:59` **STATIC_EVENT_DECLARATION** — `public static event Action<HomeHubChoice> ChoiceSelected;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:60` **EVENT_DECLARATION** — `public static event Action SettingsRequested;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:60` **STATIC_EVENT_DECLARATION** — `public static event Action SettingsRequested;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:84` **SAVE_SYSTEM_REFERENCE** — `bool canContinue = SaveSystem.HasExistingProfile;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:105` **SAVE_SYSTEM_REFERENCE** — `SaveSystem.Instance == null)`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:127` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance.StartNewProfile();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:127` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance.StartNewProfile();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:132` **SAVE_SYSTEM_REFERENCE** — `// Load remains SaveSystem's sole profile recovery/migration path.`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:133` **SAVE_SYSTEM_REFERENCE** — `SaveSystem.Instance.Load();`
...
- Codes: `SAVE_SYSTEM_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:42` **SAVE_SYSTEM_REFERENCE** — `var profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:306` **SAVE_SYSTEM_REFERENCE** — `// JobRewards.Grant + the self-bootstrapping SaveSystem (so no _Boot edit needed). This is the`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:308` **SAVE_SYSTEM_REFERENCE** — `var profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
...
- Codes: `EVENT_DECLARATION`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:37` **EVENT_DECLARATION** — `public event System.Action<RepairStage> StageChanged;`
...
- Codes: `PLAYER_PROFILE_REFERENCE`, `SAVE_SYSTEM_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs`
  - `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs:77` **SAVE_SYSTEM_REFERENCE** — `string source = Read("Gameplay", "Runtime", "Persistence", "SaveSystem.cs");`
  - `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs:81` **PLAYER_PROFILE_REFERENCE** — `StringAssert.Contains("public PlayerProfile StartNewProfile()", source);`
  - `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs:94` **SAVE_SYSTEM_REFERENCE** — `StringAssert.Contains("SaveSystem.Instance.StartNewProfile()", source);`
  - `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs:95` **SAVE_SYSTEM_REFERENCE** — `StringAssert.Contains("SaveSystem.Instance.Load();", source);`
...
- Paths: `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs`
  ...
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:275` **SAVE_SYSTEM_REFERENCE** — `SaveSystem save = FindRequired<SaveSystem>();`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:307` **SAVE_SYSTEM_REFERENCE** — `SaveSystem save = FindRequired<SaveSystem>();`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:314` **SAVE_SYSTEM_REFERENCE** — `Assert.AreEqual(identity.SaveSystemId, save.GetInstanceID(), "SaveSystem identity changed.");`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:365` **SAVE_SYSTEM_REFERENCE** — `Assert.IsNotNull(SaveSystem.Instance);`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:366` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance.Profile;`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:366` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance.Profile;`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:376` **SAVE_SYSTEM_REFERENCE** — `Assert.IsTrue(File.Exists(SaveSystem.SavePath),`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:378` **SAVE_SYSTEM_REFERENCE** — `string json = File.ReadAllText(SaveSystem.SavePath);`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:379` **PLAYER_PROFILE_REFERENCE** — `Assert.IsTrue(ProfileSerializer.TryDeserialize(json, out PlayerProfile profile),`
  - `Ziptide/Assets/Ziptide/Tests/PlayMode/RecoveryTravelSaveRoundTripTests.cs:416` **PLAYER_PROFILE_REFERENCE** — `private void OnNewGameProfileCreated(PlayerProfile profile) => _newGameProfile = profile;`
...
### `Ziptide.Gameplay.HomeHubChoice` — 2 signal(s)
...
- Codes: `CAMERA_MAIN_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Jobs/JobDirector.cs:334` **CAMERA_MAIN_REFERENCE** — `var cam = Camera.main;`
...
- Codes: `CAMERA_MAIN_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:174` **CAMERA_MAIN_REFERENCE** — `var cam = Camera.main;`
...
### `Ziptide.Editor.Patching.ShipHullBuilder` — 1 signal(s)

- Codes: `FALLBACK_MARKER`
- Paths: `Ziptide/Assets/Ziptide/Editor/Patching/ShipHullBuilder.cs`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ShipHullBuilder.cs:9` **FALLBACK_MARKER** — `/// THE INTERIM HULL (Quality Bar P4a). Terry's verdict on the 4-cube ship: "a very very poor`
...
- Codes: `FALLBACK_MARKER`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:717` **FALLBACK_MARKER** — `// Name-based fallback for rigs without XROrigin component attached.`
...
### `Ziptide.Gameplay.PistolRuntime` — 1 signal(s)

- Codes: `FALLBACK_MARKER`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/PistolRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/PistolRuntime.cs:62` **FALLBACK_MARKER** — `// Fallback: some rigs don’t route Activate events; polling ensures trigger fires while held.`
...
- Codes: `FALLBACK_MARKER`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/WorldRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/WorldRuntime.cs:78` **FALLBACK_MARKER** — `// sludge surface) → respawn-fall-loop. Marker first, profile only as fallback.`
