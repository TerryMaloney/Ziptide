...
### `Ziptide.Gameplay.ArtifactJoinRuntime` — 3 signal(s)

- Codes: `DONT_DESTROY_ON_LOAD`, `RUNTIME_BOOTSTRAP`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ArtifactJoinRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ArtifactJoinRuntime.cs:47` **RUNTIME_BOOTSTRAP** — `[RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.AfterSceneLoad)]`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ArtifactJoinRuntime.cs:52` **DONT_DESTROY_ON_LOAD** — `DontDestroyOnLoad(go);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ArtifactJoinRuntime.cs:60` **DONT_DESTROY_ON_LOAD** — `DontDestroyOnLoad(gameObject);`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:449` **DONT_DESTROY_ON_LOAD** — `DontDestroyOnLoad(_xriManager.gameObject);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:459` **DONT_DESTROY_ON_LOAD** — `DontDestroyOnLoad(_xriManager.gameObject);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:467` **DONT_DESTROY_ON_LOAD** — `DontDestroyOnLoad(_xriManager.gameObject);`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstHourDirector.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstHourDirector.cs:58` **RUNTIME_BOOTSTRAP** — `[RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.AfterSceneLoad)]`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstHourDirector.cs:63` **DONT_DESTROY_ON_LOAD** — `DontDestroyOnLoad(go);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstHourDirector.cs:71` **DONT_DESTROY_ON_LOAD** — `DontDestroyOnLoad(gameObject);`
...
### `Ziptide.Gameplay.ReentryArrivalRuntime` — 1 signal(s)
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:420` **INPUT_ACTION_REFERENCE** — `// The scene-local manager always has the correct InputActionManager+assets wired up.`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:436` **INPUT_ACTION_REFERENCE** — `// CRITICAL FIX: clear the OLD manager's InputActionManager asset list BEFORE`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:437` **INPUT_ACTION_REFERENCE** — `// destroying it. InputActionManager.OnDisable calls actionAsset.Disable() which`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:618` **INPUT_ACTION_REFERENCE** — `var primary = _xriManager != null ? _xriManager.GetComponent<InputActionManager>() : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:643` **INPUT_ACTION_REFERENCE** — `/// Guarantees the persistent rig owns its input. The scene's InputActionManager often`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:648` **INPUT_ACTION_REFERENCE** — `/// the rig references, (2) put them on an InputActionManager on the PERSISTENT manager`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:649` **INPUT_ACTION_REFERENCE** — `/// object, (3) clear the asset list on every other InputActionManager so their OnDisable`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:654` **INPUT_ACTION_REFERENCE** — `var assets = new System.Collections.Generic.List<InputActionAsset>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:655` **INPUT_ACTION_REFERENCE** — `void Add(InputActionAsset a) { if (a != null && !assets.Contains(a)) assets.Add(a); }`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:657` **INPUT_ACTION_REFERENCE** — `var allManagers = FindObjectsOfType<InputActionManager>(true);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:666` **INPUT_ACTION_REFERENCE** — `var primary = _xriManager.GetComponent<InputActionManager>()`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:667` **INPUT_ACTION_REFERENCE** — `?? _xriManager.gameObject.AddComponent<InputActionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:698` **INPUT_ACTION_REFERENCE** — `private static InputActionAsset GetActionAssetFromController(ActionBasedController c)`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:707` **INPUT_ACTION_REFERENCE** — `/// <summary>Clears m_ActionAssets on an InputActionManager so its OnDisable won't disable shared assets.</summary>`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:708` **INPUT_ACTION_REFERENCE** — `private static void ClearInputActionAssets(InputActionManager iam)`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:713` **INPUT_ACTION_REFERENCE** — `var field = typeof(InputActionManager).GetField(`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:716` **INPUT_ACTION_REFERENCE** — `field.SetValue(iam, new System.Collections.Generic.List<InputActionAsset>());`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:725` **INPUT_ACTION_REFERENCE** — `/// Clears the action asset list on an InputActionManager via reflection BEFORE`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:726` **INPUT_ACTION_REFERENCE** — `/// the manager is destroyed. This prevents InputActionManager.OnDisable from`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:732` **INPUT_ACTION_REFERENCE** — `var iam = mgr.GetComponent<InputActionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:736` **INPUT_ACTION_REFERENCE** — `var field = typeof(InputActionManager).GetField(`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:740` **INPUT_ACTION_REFERENCE** — `field.SetValue(iam, new System.Collections.Generic.List<InputActionAsset>());`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerSafetyRuntime.cs`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerSafetyRuntime.cs:54` **INPUT_ACTION_REFERENCE** — `public static bool IsTurnActionReady(InputAction action)`

### `Ziptide.Ship.ShipFlightRuntime` — 17 signal(s)

- Codes: `INPUT_ACTION_REFERENCE`, `INPUT_BUTTON_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:71` **INPUT_ACTION_REFERENCE** — `private InputAction _leftStick;`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:72` **INPUT_ACTION_REFERENCE** — `private InputAction _rightStick;`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:73` **INPUT_ACTION_REFERENCE** — `private InputAction _boostStickClick; // L3 — same finger as sprint on foot`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:74` **INPUT_ACTION_REFERENCE** — `private InputAction _boostButton; // A — the CONTROLS_AND_FLIGHT boost button`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:75` **INPUT_ACTION_REFERENCE** — `private InputAction _rollLeftButton; // X`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:76` **INPUT_ACTION_REFERENCE** — `private InputAction _rollRightButton; // B`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:77` **INPUT_ACTION_REFERENCE** — `private InputAction _fireAction; // RT — fire ship weapon (CONTROLS_AND_FLIGHT)`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:180` **INPUT_ACTION_REFERENCE** — `_leftStick = new InputAction("ZiptideFlightThrottle", InputActionType.Value);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:182` **INPUT_ACTION_REFERENCE** — `_rightStick = new InputAction("ZiptideFlightSteer", InputActionType.Value);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:184` **INPUT_ACTION_REFERENCE** — `_boostStickClick = new InputAction("ZiptideFlightBoostL3", InputActionType.Button);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:186` **INPUT_ACTION_REFERENCE** — `_boostButton = new InputAction("ZiptideFlightBoostA", InputActionType.Button);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:187` **INPUT_BUTTON_REFERENCE** — `_boostButton.AddBinding("<XRController>{RightHand}/primaryButton"); // A`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:188` **INPUT_ACTION_REFERENCE** — `_rollLeftButton = new InputAction("ZiptideFlightRollL", InputActionType.Button);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:189` **INPUT_BUTTON_REFERENCE** — `_rollLeftButton.AddBinding("<XRController>{LeftHand}/primaryButton"); // X`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:190` **INPUT_ACTION_REFERENCE** — `_rollRightButton = new InputAction("ZiptideFlightRollR", InputActionType.Button);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:191` **INPUT_BUTTON_REFERENCE** — `_rollRightButton.AddBinding("<XRController>{RightHand}/secondaryButton"); // B`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:192` **INPUT_ACTION_REFERENCE** — `_fireAction = new InputAction("ZiptideFlightFire", InputActionType.Button);`
...
### `Ziptide.Editor.Patching.ScenePatcherSpaceLane` — 23 signal(s)
...
- Paths: `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:112` **NEW_GAME_OBJECT** — `var root = new GameObject("__SPACELANE_ROOT").transform;`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:153` **NEW_GAME_OBJECT** — `var frame = new GameObject("CockpitFrame").transform;`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:165` **NEW_GAME_OBJECT** — `var compass = new GameObject("HelmCompass");`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:183` **NEW_GAME_OBJECT** — `var lane = new GameObject("LaneContent").transform;`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:214` **NEW_GAME_OBJECT** — `var field = new GameObject("DebrisField").transform;`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:227` **NEW_GAME_OBJECT** — `var piece = new GameObject(kind + "_" + i).transform;`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:367` **NEW_GAME_OBJECT** — `var aft = new GameObject("AftSection_Burst").transform;`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:392` **NEW_GAME_OBJECT** — `var drone = new GameObject("Drone_" + index);`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:426` **NEW_GAME_OBJECT** — `var arm = new GameObject(s < 0 ? "Arm_L" : "Arm_R").transform;`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:436` **NEW_GAME_OBJECT** — `var panel = new GameObject("AccessPanel").transform;`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:470` **NEW_GAME_OBJECT** — `var ring = new GameObject("Ring_" + index).transform;`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:477` **NEW_GAME_OBJECT** — `var structure = new GameObject("Truss").transform;`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:535` **NEW_GAME_OBJECT** — `var label = new GameObject("CatchNumber");`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:539` **TEXTMESH_COMPONENT** — `var text = label.AddComponent<TextMesh>();`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:562` **NEW_GAME_OBJECT** — `var lamps = new GameObject("Lamps").transform;`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:645` **NEW_GAME_OBJECT** — `var cradle = new GameObject(Name);`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:653` **CREATE_PRIMITIVE** — `var hulk = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:661` **NEW_GAME_OBJECT** — `var marker = new GameObject("__SALVAGE_ARTIFACT_HALF_A");`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:688` **CREATE_PRIMITIVE** — `var scrap = GameObject.CreatePrimitive(`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:829` **CREATE_PRIMITIVE** — `var go = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:842` **SHADER_FIND** — `var shader = Shader.Find("Universal Render Pipeline/Lit");`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:843` **SHADER_FIND** — `if (shader == null) shader = Shader.Find("Standard");`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:845` **RUNTIME_MATERIAL_CREATE** — `var mat = new Material(shader);`
...
- Paths: `Ziptide/Assets/Ziptide/Editor/Patching/ToxicCityVehicleBuilder.cs`
  ...
  - `Ziptide/Assets/Ziptide/Editor/Patching/ToxicCityVehicleBuilder.cs:73` **NEW_GAME_OBJECT** — `Transform bay = new GameObject("VehicleBay_" + id).transform;`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ToxicCityVehicleBuilder.cs:77` **CREATE_PRIMITIVE** — `GameObject pad = GameObject.CreatePrimitive(PrimitiveType.Cube);`
...
### `Ziptide.Gameplay.ArmorVignetteRuntime` — 4 signal(s)

- Codes: `CREATE_PRIMITIVE`, `RUNTIME_MATERIAL_CREATE`, `SHADER_FIND`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/ArmorVignetteRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/ArmorVignetteRuntime.cs:73` **CREATE_PRIMITIVE** — `_quad = GameObject.CreatePrimitive(PrimitiveType.Quad);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/ArmorVignetteRuntime.cs:88` **SHADER_FIND** — `Shader shader = Shader.Find("Sprites/Default");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/ArmorVignetteRuntime.cs:89` **SHADER_FIND** — `if (shader == null) shader = Shader.Find("Universal Render Pipeline/Unlit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/ArmorVignetteRuntime.cs:90` **RUNTIME_MATERIAL_CREATE** — `_renderer.material = new Material(shader);`

### `Ziptide.Gameplay.ArtifactJoinRuntime` — 1 signal(s)

- Codes: `NEW_GAME_OBJECT`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ArtifactJoinRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ArtifactJoinRuntime.cs:51` **NEW_GAME_OBJECT** — `var go = new GameObject("__ArtifactJoin");`
...
### `Ziptide.Gameplay.BeaconThreadRuntime` — 3 signal(s)

- Codes: `RUNTIME_MATERIAL_CREATE`, `SHADER_FIND`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/BeaconThreadRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/BeaconThreadRuntime.cs:44` **SHADER_FIND** — `Shader shader = Shader.Find("Universal Render Pipeline/Unlit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/BeaconThreadRuntime.cs:45` **SHADER_FIND** — `if (shader == null) shader = Shader.Find("Sprites/Default");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/BeaconThreadRuntime.cs:46` **RUNTIME_MATERIAL_CREATE** — `_material = new Material(shader);`
...
- Codes: `NEW_GAME_OBJECT`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:339` **NEW_GAME_OBJECT** — `var go = new GameObject(Ziptide.Core.ZiptideConstants.GoBeltRig);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:464` **NEW_GAME_OBJECT** — `var go = new GameObject("__XRI");`
...
### `Ziptide.Gameplay.FirstDestinationHelmRuntime` — 7 signal(s)

- Codes: `CREATE_PRIMITIVE`, `NEW_GAME_OBJECT`, `TEXTMESH_COMPONENT`, `XR_INTERACTABLE_COMPONENT`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:100` **CREATE_PRIMITIVE** — `var tile = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:107` **XR_INTERACTABLE_COMPONENT** — `var interactable = tile.AddComponent<XRSimpleInteractable>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:119` **NEW_GAME_OBJECT** — `var go = new GameObject("Label_W001");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:122` **TEXTMESH_COMPONENT** — `var tm = go.AddComponent<TextMesh>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:167` **XR_INTERACTABLE_COMPONENT** — `if (grab == null) grab = gameObject.AddComponent<XRGrabInteractable>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:174` **NEW_GAME_OBJECT** — `var label = new GameObject("Label_BUNK_KEEPSAKE");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:177` **TEXTMESH_COMPONENT** — `var tm = label.AddComponent<TextMesh>();`

### `Ziptide.Gameplay.FirstHourDirector` — 1 signal(s)

- Codes: `NEW_GAME_OBJECT`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstHourDirector.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstHourDirector.cs:62` **NEW_GAME_OBJECT** — `var go = new GameObject("__FirstHourDirector");`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:274` **NEW_GAME_OBJECT** — `var go = new GameObject("__HOME_HUB_COMFORT_SETTINGS");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:298` **CREATE_PRIMITIVE** — `var board = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:330` **CREATE_PRIMITIVE** — `var tile = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:337` **XR_INTERACTABLE_COMPONENT** — `var interactable = tile.AddComponent<XRSimpleInteractable>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:481` **NEW_GAME_OBJECT** — `var go = new GameObject("Label_" + text.Replace(' ', '_').Replace('\n', '_'));`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:484` **TEXTMESH_COMPONENT** — `var tm = go.AddComponent<TextMesh>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:503` **SHADER_FIND** — `Shader shader = Shader.Find("Universal Render Pipeline/Lit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:504` **SHADER_FIND** — `if (shader == null) shader = Shader.Find("Standard");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:506` **RUNTIME_MATERIAL_CREATE** — `var material = new Material(shader);`
...
### `Ziptide.Gameplay.KeySocketRuntime` — 4 signal(s)

- Codes: `CREATE_PRIMITIVE`, `RUNTIME_MATERIAL_CREATE`, `SHADER_FIND`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/KeySocketRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/KeySocketRuntime.cs:142` **CREATE_PRIMITIVE** — `var ring = GameObject.CreatePrimitive(PrimitiveType.Cylinder);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/KeySocketRuntime.cs:151` **SHADER_FIND** — `Shader shader = Shader.Find("Universal Render Pipeline/Lit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/KeySocketRuntime.cs:152` **SHADER_FIND** — `if (shader == null) shader = Shader.Find("Standard");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/KeySocketRuntime.cs:156` **RUNTIME_MATERIAL_CREATE** — `var material = new Material(shader);`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:477` **SHADER_FIND** — `Shader shader = Shader.Find("Universal Render Pipeline/Lit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:478` **SHADER_FIND** — `if (shader == null) shader = Shader.Find("Standard");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:481` **RUNTIME_MATERIAL_CREATE** — `var material = new Material(shader);`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:57` **NEW_GAME_OBJECT** — `var hangar = new GameObject("HangarBay");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:71` **NEW_GAME_OBJECT** — `var room = new GameObject("Quarters");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:280` **NEW_GAME_OBJECT** — `var rackGo = new GameObject("ArmouryRack");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:357` **NEW_GAME_OBJECT** — `_helmRowsRoot = new GameObject("HelmRows").transform;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:413` **NEW_GAME_OBJECT** — `var streakRoot = new GameObject("__FlyOutStreaks").transform;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:416` **CREATE_PRIMITIVE** — `var sGo = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:424` **SHADER_FIND** — `var shader = Shader.Find("Universal Render Pipeline/Unlit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:425` **SHADER_FIND** — `if (shader == null) shader = Shader.Find("Universal Render Pipeline/Lit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:428` **RUNTIME_MATERIAL_CREATE** — `var mat = new Material(shader);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:441` **NEW_GAME_OBJECT** — `var countGo = new GameObject("__DepartReadout");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:442` **TEXTMESH_COMPONENT** — `var countText = countGo.AddComponent<TextMesh>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:524` **CREATE_PRIMITIVE** — `var go = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:538` **NEW_GAME_OBJECT** — `var root = new GameObject(name);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:541` **CREATE_PRIMITIVE** — `var plate = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:548` **XR_INTERACTABLE_COMPONENT** — `var interactable = plate.AddComponent<XRSimpleInteractable>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:555` **NEW_GAME_OBJECT** — `var textGo = new GameObject("Label");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:556` **TEXTMESH_COMPONENT** — `var tm = textGo.AddComponent<TextMesh>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:573` **SHADER_FIND** — `var shader = Shader.Find("Universal Render Pipeline/Lit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:574` **SHADER_FIND** — `if (shader == null) shader = Shader.Find("Standard");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:576` **RUNTIME_MATERIAL_CREATE** — `var mat = new Material(shader);`

### `Ziptide.Gameplay.ShipCastOffRuntime` — 6 signal(s)

- Codes: `CREATE_PRIMITIVE`, `NEW_GAME_OBJECT`, `TEXTMESH_COMPONENT`, `XR_INTERACTABLE_COMPONENT`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs:144` **NEW_GAME_OBJECT** — `var console = new GameObject("CastOffConsole");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs:153` **CREATE_PRIMITIVE** — `var pillar = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs:160` **CREATE_PRIMITIVE** — `var button = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs:171` **NEW_GAME_OBJECT** — `var label = new GameObject("Label_PUNCH_IT");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs:174` **TEXTMESH_COMPONENT** — `var tm = label.AddComponent<TextMesh>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs:183` **XR_INTERACTABLE_COMPONENT** — `var interactable = button.AddComponent<XRSimpleInteractable>();`
...
### `Ziptide.Gameplay.SpaceSalvageItemRuntime` — 4 signal(s)

- Codes: `CREATE_PRIMITIVE`, `RUNTIME_MATERIAL_CREATE`, `SHADER_FIND`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/SpaceSalvageItemRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/SpaceSalvageItemRuntime.cs:61` **CREATE_PRIMITIVE** — `var glow = GameObject.CreatePrimitive(PrimitiveType.Sphere);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/SpaceSalvageItemRuntime.cs:70` **SHADER_FIND** — `Shader shader = Shader.Find("Universal Render Pipeline/Unlit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/SpaceSalvageItemRuntime.cs:71` **SHADER_FIND** — `if (shader == null) shader = Shader.Find("Universal Render Pipeline/Lit");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/SpaceSalvageItemRuntime.cs:75` **RUNTIME_MATERIAL_CREATE** — `var material = new Material(shader);`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/MeleeWeaponRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/MeleeWeaponRuntime.cs:61` **XR_INTERACTABLE_COMPONENT** — `[RequireComponent(typeof(XRGrabInteractable))]`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/MeleeWeaponRuntime.cs:125` **NEW_GAME_OBJECT** — `GameObject go = new GameObject(SemanticGripName);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/MeleeWeaponRuntime.cs:249` **CREATE_PRIMITIVE** — `GameObject s = GameObject.CreatePrimitive(PrimitiveType.Sphere);`
...
- Codes: `CREATE_PRIMITIVE`, `NEW_GAME_OBJECT`, `TEXTMESH_COMPONENT`, `XR_INTERACTABLE_COMPONENT`
- Paths: `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:211` **CREATE_PRIMITIVE** — `var console = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:223` **NEW_GAME_OBJECT** — `var statusGo = new GameObject("FlightStatus");`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:227` **TEXTMESH_COMPONENT** — `_statusText = statusGo.AddComponent<TextMesh>();`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:235` **CREATE_PRIMITIVE** — `_returnPanel = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:242` **XR_INTERACTABLE_COMPONENT** — `var ret = _returnPanel.AddComponent<XRSimpleInteractable>();`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:257` **CREATE_PRIMITIVE** — `var tile = GameObject.CreatePrimitive(PrimitiveType.Cube);`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:264` **XR_INTERACTABLE_COMPONENT** — `var interactable = tile.AddComponent<XRSimpleInteractable>();`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:271` **NEW_GAME_OBJECT** — `var label = new GameObject("Label");`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:275` **TEXTMESH_COMPONENT** — `var tm = label.AddComponent<TextMesh>();`
...
- Paths: `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs`
  - `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs:135` **NEW_GAME_OBJECT** — `StringAssert.Contains("new GameObject(\"__HOME_HUB_RUNTIME\").AddComponent<HomeHubRuntime>()", source);`
  - `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs:166` **NEW_GAME_OBJECT** — `StringAssert.Contains("new GameObject(\"__HOME_HUB_COMFORT_SETTINGS\")", source);`
  - `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs:179` **NEW_GAME_OBJECT** — `var go = new GameObject("castoff-test");`
  - `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs:204` **NEW_GAME_OBJECT** — `var go = new GameObject("bunk-test");`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:417` **XRI_MANAGER_LOOKUP** — `var allManagers = FindObjectsOfType<XRInteractionManager>(true);`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:466` **XRI_MANAGER_CREATE** — `_xriManager = go.AddComponent<XRInteractionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:493` **XRI_MANAGER_ASSIGN** — `i.interactionManager = _xriManager;`
...
- Codes: `XRI_MANAGER_ASSIGN`, `XRI_MANAGER_LOOKUP`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:108` **XRI_MANAGER_LOOKUP** — `var manager = FindObjectOfType<XRInteractionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:109` **XRI_MANAGER_ASSIGN** — `if (manager != null) interactable.interactionManager = manager;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:168` **XRI_MANAGER_LOOKUP** — `var manager = FindObjectOfType<XRInteractionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:169` **XRI_MANAGER_ASSIGN** — `if (manager != null) grab.interactionManager = manager;`
...
- Codes: `XRI_MANAGER_ASSIGN`, `XRI_MANAGER_LOOKUP`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:339` **XRI_MANAGER_LOOKUP** — `if (manager == null) manager = FindObjectOfType<XRInteractionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:345` **XRI_MANAGER_ASSIGN** — `interactable.interactionManager = manager;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:383` **XRI_MANAGER_LOOKUP** — `XRInteractionManager manager = FindObjectOfType<XRInteractionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:387` **XRI_MANAGER_ASSIGN** — `interactable.interactionManager = manager;`
...
- Codes: `XRI_MANAGER_ASSIGN`, `XRI_MANAGER_LOOKUP`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:451` **XRI_MANAGER_LOOKUP** — `XRInteractionManager manager = FindObjectOfType<XRInteractionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/RepairableMachine.cs:452` **XRI_MANAGER_ASSIGN** — `if (manager != null) interactable.interactionManager = manager;`

### `Ziptide.Gameplay.ShipBoardingStation` — 2 signal(s)

- Codes: `XRI_MANAGER_ASSIGN`, `XRI_MANAGER_LOOKUP`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:549` **XRI_MANAGER_LOOKUP** — `var mgr = Object.FindObjectOfType<XRInteractionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:550` **XRI_MANAGER_ASSIGN** — `if (mgr != null) interactable.interactionManager = mgr;`

### `Ziptide.Gameplay.ShipCastOffRuntime` — 2 signal(s)

- Codes: `XRI_MANAGER_ASSIGN`, `XRI_MANAGER_LOOKUP`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs:184` **XRI_MANAGER_LOOKUP** — `var mgr = FindObjectOfType<XRInteractionManager>();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs:185` **XRI_MANAGER_ASSIGN** — `if (mgr != null) interactable.interactionManager = mgr;`
...
- Codes: `XRI_MANAGER_ASSIGN`, `XRI_MANAGER_LOOKUP`
- Paths: `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:286` **XRI_MANAGER_LOOKUP** — `var mgr = Object.FindObjectOfType<XRInteractionManager>();`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:287` **XRI_MANAGER_ASSIGN** — `if (mgr != null) interactable.interactionManager = mgr;`
...
### `Ziptide.Gameplay.ArtifactJoinRuntime` — 8 signal(s)

- Codes: `EVENT_DECLARATION`, `PLAYER_PROFILE_REFERENCE`, `SAVE_SYSTEM_REFERENCE`, `STATIC_EVENT_DECLARATION`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ArtifactJoinRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ArtifactJoinRuntime.cs:41` **EVENT_DECLARATION** — `public static event System.Action Joined;`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ArtifactJoinRuntime.cs:63` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ArtifactJoinRuntime.cs:63` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ArtifactJoinRuntime.cs:146` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ArtifactJoinRuntime.cs:146` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ArtifactJoinRuntime.cs:198` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ArtifactJoinRuntime.cs:198` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
...
### `Ziptide.Gameplay.BeaconThreadRuntime` — 2 signal(s)

- Codes: `PLAYER_PROFILE_REFERENCE`, `SAVE_SYSTEM_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/BeaconThreadRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/BeaconThreadRuntime.cs:61` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/BeaconThreadRuntime.cs:61` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
...
- Codes: `EVENT_DECLARATION`, `STATIC_EVENT_DECLARATION`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:15` **EVENT_DECLARATION** — `public static event Action<string> FirstDestinationSelected;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:15` **STATIC_EVENT_DECLARATION** — `public static event Action<string> FirstDestinationSelected;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:154` **EVENT_DECLARATION** — `public static event Action<string> NamedBunkObjectGrabbed;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstDestinationHelmRuntime.cs:154` **STATIC_EVENT_DECLARATION** — `public static event Action<string> NamedBunkObjectGrabbed;`

### `Ziptide.Gameplay.FirstHourDirector` — 7 signal(s)

- Codes: `PLAYER_PROFILE_REFERENCE`, `SAVE_SYSTEM_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstHourDirector.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstHourDirector.cs:128` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstHourDirector.cs:128` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstHourDirector.cs:256` **PLAYER_PROFILE_REFERENCE** — `private void OnNewGameProfile(PlayerProfile profile) => Accept("NEW_GAME_PROFILE_CREATED");`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstHourDirector.cs:366` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstHourDirector.cs:366` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstHourDirector.cs:373` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/FirstHourDirector.cs:373` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Inventory/HolsterSocketInteractor.cs`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Inventory/HolsterSocketInteractor.cs:195` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Inventory/HolsterSocketInteractor.cs:195` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs`
  ...
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:114` **EVENT_DECLARATION** — `public static event Action<bool> BootPresentationReady;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:114` **STATIC_EVENT_DECLARATION** — `public static event Action<bool> BootPresentationReady;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:115` **EVENT_DECLARATION** — `public static event Action<PlayerProfile> NewGameProfileCreated;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:115` **PLAYER_PROFILE_REFERENCE** — `public static event Action<PlayerProfile> NewGameProfileCreated;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:115` **STATIC_EVENT_DECLARATION** — `public static event Action<PlayerProfile> NewGameProfileCreated;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:116` **EVENT_DECLARATION** — `public static event Action<HomeHubChoice> ChoiceSelected;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:116` **STATIC_EVENT_DECLARATION** — `public static event Action<HomeHubChoice> ChoiceSelected;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:117` **EVENT_DECLARATION** — `public static event Action SettingsRequested;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:117` **STATIC_EVENT_DECLARATION** — `public static event Action SettingsRequested;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:144` **SAVE_SYSTEM_REFERENCE** — `bool canContinue = SaveSystem.HasExistingProfile;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:229` **SAVE_SYSTEM_REFERENCE** — `SaveSystem.Instance == null)`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:255` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance.StartNewProfile();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:255` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance.StartNewProfile();`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:260` **SAVE_SYSTEM_REFERENCE** — `// Load remains SaveSystem's sole profile recovery/migration path.`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:261` **SAVE_SYSTEM_REFERENCE** — `SaveSystem.Instance.Load();`
...
- Codes: `PLAYER_PROFILE_REFERENCE`, `SAVE_SYSTEM_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/KeySocketRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/KeySocketRuntime.cs:42` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/KeySocketRuntime.cs:42` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/KeySocketRuntime.cs:104` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/KeySocketRuntime.cs:104` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
...
### `Ziptide.Gameplay.ShipBoardingStation` — 6 signal(s)

- Codes: `PLAYER_PROFILE_REFERENCE`, `SAVE_SYSTEM_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:83` **SAVE_SYSTEM_REFERENCE** — `var prof = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:142` **SAVE_SYSTEM_REFERENCE** — `var prof = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:301` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:301` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:361` **SAVE_SYSTEM_REFERENCE** — `var profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingStation.cs:381` **SAVE_SYSTEM_REFERENCE** — `SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null) ?? "?")))`

### `Ziptide.Gameplay.ShipCastOffRuntime` — 3 signal(s)

- Codes: `EVENT_DECLARATION`, `SAVE_SYSTEM_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs:82` **EVENT_DECLARATION** — `public event Action<string> DestinationSelected;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs:230` **SAVE_SYSTEM_REFERENCE** — `var profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs:262` **SAVE_SYSTEM_REFERENCE** — `var profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
...
- Codes: `PLAYER_PROFILE_REFERENCE`, `SAVE_SYSTEM_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/SpaceSalvageItemRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/SpaceSalvageItemRuntime.cs:43` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/SpaceSalvageItemRuntime.cs:43` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/SpaceSalvageItemRuntime.cs:117` **PLAYER_PROFILE_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/SpaceSalvageItemRuntime.cs:117` **SAVE_SYSTEM_REFERENCE** — `PlayerProfile profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
...
- Codes: `SAVE_SYSTEM_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:155` **SAVE_SYSTEM_REFERENCE** — `var profile = SaveSystem.Instance != null ? SaveSystem.Instance.Profile : null;`
...
- Codes: `PLAYER_PROFILE_REFERENCE`, `SAVE_SYSTEM_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs`
  - `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs:146` **SAVE_SYSTEM_REFERENCE** — `string source = Read("Gameplay", "Runtime", "Persistence", "SaveSystem.cs");`
  - `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs:150` **PLAYER_PROFILE_REFERENCE** — `StringAssert.Contains("public PlayerProfile StartNewProfile()", source);`
  - `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs:163` **SAVE_SYSTEM_REFERENCE** — `StringAssert.Contains("SaveSystem.Instance.StartNewProfile()", source);`
  - `Ziptide/Assets/Ziptide/Tests/EditMode/HomeHubFlowTests.cs:164` **SAVE_SYSTEM_REFERENCE** — `StringAssert.Contains("SaveSystem.Instance.Load();", source);`
...
### `Ziptide.Editor.Patching.ScenePatcherSpaceLane` — 2 signal(s)

- Codes: `RENDER_SETTINGS_MUTATION`
- Paths: `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:764` **RENDER_SETTINGS_MUTATION** — `RenderSettings.ambientMode = UnityEngine.Rendering.AmbientMode.Flat;`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:765` **RENDER_SETTINGS_MUTATION** — `RenderSettings.ambientLight = new Color(0.06f, 0.07f, 0.10f);`
...
- Codes: `CAMERA_MAIN_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:171` **CAMERA_MAIN_REFERENCE** — `Camera cam = Camera.main;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:283` **CAMERA_MAIN_REFERENCE** — `Camera cam = Camera.main;`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Tutorial/HomeHubRuntime.cs:413` **CAMERA_MAIN_REFERENCE** — `Camera cam = Camera.main;`
...
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingPresentationGuard.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/World/ShipBoardingPresentationGuard.cs:194` **CAMERA_MAIN_REFERENCE** — `if (_viewer == null) _viewer = Camera.main;`

### `Ziptide.Gameplay.ShipCastOffRuntime` — 1 signal(s)

- Codes: `CAMERA_MAIN_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/ShipCastOffRuntime.cs:301` **CAMERA_MAIN_REFERENCE** — `var cam = Camera.main;`

### `Ziptide.Gameplay.SpaceSalvageItemRuntime` — 2 signal(s)

- Codes: `CAMERA_MAIN_REFERENCE`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/SpaceSalvageItemRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/SpaceSalvageItemRuntime.cs:91` **CAMERA_MAIN_REFERENCE** — `// Camera.main depends on a MainCamera tag that a generated scene is not guaranteed to`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Story/SpaceSalvageItemRuntime.cs:95` **CAMERA_MAIN_REFERENCE** — `Camera cam = Camera.main;`
...
- Paths: `Ziptide/Assets/Ziptide/Content/Runtime/City/CityLayoutDefinition.cs`
  - `Ziptide/Assets/Ziptide/Content/Runtime/City/CityLayoutDefinition.cs:507` **FALLBACK_MARKER** — `/// <summary>The shipyard berth + a static (non-flyable) ship placeholder.</summary>`
...
### `Ziptide.Core.MeleeGripCore` — 2 signal(s)

- Codes: `FALLBACK_MARKER`
- Paths: `Ziptide/Assets/Ziptide/Core/Runtime/MeleeGripCore.cs`
  - `Ziptide/Assets/Ziptide/Core/Runtime/MeleeGripCore.cs:109` **FALLBACK_MARKER** — `Vector3 fallback = Mathf.Abs(Vector3.Dot(a, Vector3.up)) < 0.9f ? Vector3.up : Vector3.forward;`
  - `Ziptide/Assets/Ziptide/Core/Runtime/MeleeGripCore.cs:110` **FALLBACK_MARKER** — `up = Vector3.ProjectOnPlane(fallback, a);`
...
- Paths: `Ziptide/Assets/Ziptide/Core/Runtime/ZiptideConstants.cs`
  - `Ziptide/Assets/Ziptide/Core/Runtime/ZiptideConstants.cs:25` **FALLBACK_MARKER** — `// 2026-07-06 (Picasso): REVERTED the June-18 Sandbox dev-bypass — booting into the graybox left`
...
- Codes: `FALLBACK_MARKER`
- Paths: `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs`
  - `Ziptide/Assets/Ziptide/Editor/Patching/ScenePatcherSpaceLane.cs:131` **FALLBACK_MARKER** — `// giant, the sibling moon, the sun and the starfield instead of the placeholder void.`
...
- Paths: `Ziptide/Assets/Ziptide/Editor/Patching/SkyVistaLibrary.cs`
  - `Ziptide/Assets/Ziptide/Editor/Patching/SkyVistaLibrary.cs:77` **FALLBACK_MARKER** — `/// SPACE OVER THE MOSS. The flight trial shipped against a near-black placeholder sky, which`
...
- Paths: `Ziptide/Assets/Ziptide/Editor/Patching/WorldLayoutLibrary.cs`
  - `Ziptide/Assets/Ziptide/Editor/Patching/WorldLayoutLibrary.cs:739` **FALLBACK_MARKER** — `// High-ground crossings over the tide flats — the flood-timing feel in graybox.`
...
- Codes: `FALLBACK_MARKER`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Player/PlayerRigPersistence.cs:770` **FALLBACK_MARKER** — `// Name-based fallback for rigs without XROrigin component attached.`
...
- Codes: `FALLBACK_MARKER`
- Paths: `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/MeleeWeaponRuntime.cs`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/MeleeWeaponRuntime.cs:24` **FALLBACK_MARKER** — `Vector3 fallback = Mathf.Abs(Vector3.Dot(axis, Vector3.up)) < 0.9f`
  - `Ziptide/Assets/Ziptide/Gameplay/Runtime/Weapons/MeleeWeaponRuntime.cs:26` **FALLBACK_MARKER** — `up = Vector3.ProjectOnPlane(fallback, axis);`
...
- Codes: `FALLBACK_MARKER`
- Paths: `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs`
  - `Ziptide/Assets/Ziptide/Ship/Runtime/ShipFlightRuntime.cs:603` **FALLBACK_MARKER** — `// ── Rig plumbing (ShipBoardingStation patterns — teleport, never parent) ───────────────────`
...
- Codes: `FALLBACK_MARKER`
- Paths: `Ziptide/Assets/Ziptide/Tests/EditMode/RecoveryPlayabilityDeviceTests.cs`
  - `Ziptide/Assets/Ziptide/Tests/EditMode/RecoveryPlayabilityDeviceTests.cs:121` **FALLBACK_MARKER** — `"The no-ray direct-hand fallback must remain valid for the three-tile layout.");`
